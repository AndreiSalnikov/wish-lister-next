  ...
  return (
    <div
      ...
      <div className={styles.popupRegisterLogin__container}>
        ...
        {isEmailRegisterClicked &&
          <>
            <form className={styles.popupRegisterLogin__formRegister} noValidate>
              {!isLoginButtonClicked &&
                <>
                  <input className={styles.popupRegisterLogin__input} placeholder={'Имя'}/>
                  <span className={styles.popupRegisterLogin__error}></span>
                </>
              }
              <input className={styles.popupRegisterLogin__input} placeholder={'Адрес электронной почты'}
                     type={"email"}/>
              <span className={styles.popupRegisterLogin__error}></span>
              <input className={styles.popupRegisterLogin__input} placeholder={'Пароль'} type={"password"}/>
              <span className={styles.popupRegisterLogin__error}></span>
              {!isLoginButtonClicked &&
                <>
                  <input className={styles.popupRegisterLogin__input} placeholder={'Повторите пароль'}
                         type={"password"}/>
                  <span className={styles.popupRegisterLogin__error}></span>
                </>}
              <button
                className={styles.popupRegisterLogin__button}>{isLoginButtonClicked ? 'Войти' : 'Зарегистрироваться'}</button>
            </form>
            <div className={styles.popupRegisterLogin__or}>
              <span
            ...
            <div className={styles.popupRegisterLogin__socialBox}>
