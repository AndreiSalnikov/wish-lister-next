    ...
    <>
      ...
      <div className={styles.gift} key={gift._id}>
        {user?._id === wishlistOwner && isEditing &&
          <svg className={styles.list__close} onClick={deleteGift} xmlns="http://www.w3.org/2000/svg" width="16"
               height="16"
        ...
        {user?._id === wishlistOwner && isEditing &&
          <svg onClick={editGift} fill="none" stroke="currentColor" viewBox="0 0 24 24" width="16" height="16"
